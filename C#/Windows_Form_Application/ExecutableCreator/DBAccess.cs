...
namespace DatabaseProject
{
    class DBAccess
    {
        ...
        private static string strConnString = "Data Source=(localdb)\\BillingAppLocalDbServer;AttachDbFilename=" + System.IO.Path.GetFullPath("NameSurname.mdf") + ";Integrated Security=True;Connect Timeout=30";
